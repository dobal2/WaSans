...
Undertale의 Sans 전투에서 영감을 받은 2D 픽셀아트 액션 플랫포머 보스러시 게임.
스테이지를 클리어하며 다양한 적을 처리하고, 최종 보스 Sans와 싸운다.
...
2. `Assets/Scenes/MainGame.unity` 씬을 열고 Play
